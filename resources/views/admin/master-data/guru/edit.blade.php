...
@section('content')
    <div class="body flex-grow-1">
        <div class="container-lg px-4 mb-4">
            ...
            @endif
            <form action="/master-data/guru/{{ $guru->id }}/update" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row g-3">
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        ...
                        <input class="form-control" id="nim_nip" placeholder="Masukkan NIP" required name="nim_nip"
                            value="{{ $guru->nim_nip }}">
                    </div>
                    <div class="col-12">
